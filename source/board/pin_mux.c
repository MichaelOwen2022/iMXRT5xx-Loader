...
#if 1
    const uint32_t port3_pin16_config = (/* Pin is configured as FC5_TXD_SCL_MISO_WS */
                                         IOPCTL_PIO_FUNC5 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT3 PIN16 (coords: C9) is configured as FC5_TXD_SCL_MISO_WS */
    IOPCTL_PinMuxSet(IOPCTL, 3U, 16U, port3_pin16_config);

    const uint32_t port3_pin17_config = (/* Pin is configured as FC5_RXD_SDA_MOSI_DATA */
                                         IOPCTL_PIO_FUNC5 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT3 PIN17 (coords: D8) is configured as FC5_RXD_SDA_MOSI_DATA */

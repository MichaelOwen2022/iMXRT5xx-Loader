/** @file wlan_txpwrlimit_cfg_murata_1XK_CA.h
 *
 *  @brief  This file provides Murata 1XK WLAN CA Tx Power Limit APIs.
 *
        ...
        .txpwrlimit_config[1] =
            {
                ...
                .txpwrlimit_entry = {{1, 14}, {2, 14}, {3, 14}, {4, 14}, {5, 14}, {6, 14}, {7, 12}, {8, 12}, {9, 12}},
            },
        .txpwrlimit_config[2] =
            {
                .num_mod_grps = 9,
        ...
        .txpwrlimit_config[4] =
            {
                ...
                .txpwrlimit_entry = {{1, 16}, {2, 16}, {3, 16}, {4, 15}, {5, 15}, {6, 15}, {7, 14}, {8, 14}, {9, 14}},
            },
        .txpwrlimit_config[5] =
            {
                .num_mod_grps = 9,
        ...
        .txpwrlimit_config[6] =
            {
                ...
                .txpwrlimit_entry = {{1, 16}, {2, 16}, {3, 16}, {4, 15}, {5, 15}, {6, 15}, {7, 12}, {8, 12}, {9, 12}},
            },
        .txpwrlimit_config[7] =
            {
                .num_mod_grps = 9,

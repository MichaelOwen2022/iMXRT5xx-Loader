/** @file wlan_txpwrlimit_cfg_murata_1ZM_US
 *
    ...
    .txpwrlimit_config[2] =
        {
            ...
            .txpwrlimit_entry =
                {{0, 17}, {1, 14}, {2, 14}, {3, 14}, {4, 13}, {5, 13}, {6, 13}, {7, 10}, {8, 10}, {9, 10}},
        },
    .txpwrlimit_config[3] =
        {
            .num_mod_grps = 10,
            ...
            .txpwrlimit_entry =
                {{0, 17}, {1, 17}, {2, 16}, {3, 16}, {4, 16}, {5, 15}, {6, 15}, {7, 10}, {8, 10}, {9, 10}},
        },
    .txpwrlimit_config[4] =
        {
            .num_mod_grps = 10,
            ...
            .txpwrlimit_config[0] =
                {
                    ...
                    .txpwrlimit_entry =
                        {{0, 0}, {1, 14}, {2, 14}, {3, 14}, {4, 13}, {5, 13}, {6, 13}, {7, 12}, {8, 12}, {9, 12}},
                },
            .txpwrlimit_config[1] =
                {
                    .num_mod_grps = 9,
                    ...
                    .txpwrlimit_entry =
                        {{0, 0}, {1, 15}, {2, 15}, {3, 15}, {4, 14}, {5, 14}, {6, 14}, {7, 12}, {8, 12}, {9, 12}},
                },
            .txpwrlimit_config[2] =
                {
                    .num_mod_grps = 9,

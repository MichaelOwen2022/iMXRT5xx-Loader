/** @file wlan_txpwrlimit_cfg_murata_1ZM_JP
 *
 *  @brief  This file provides Murata 1ZM WLAN JP Tx Power Limit APIs.
 *
    ...
    .txpwrlimit_config[2] =
        {
            ...
            .txpwrlimit_entry =
                {{0, 17}, {1, 17}, {2, 16}, {3, 16}, {4, 16}, {5, 15}, {6, 15}, {7, 15}, {8, 14}, {9, 14}},
        },
    .txpwrlimit_config[3] =
        {
            .num_mod_grps = 10,

                ...
                const int32_t *                x, int N )
{
  ...
  for ( m=0; m<M-1; m++ )
  {
    ...
    for ( n=0; n<(N>>1); n++ )
    {
      ...
      acc0 = AE_MULF32R_HL(xin   , b0b0);
      AE_MULAF32R_HL(acc0, sx1sx0, b1b2);
      ...
      // Q17.46 <- Q17.46 + [ Q30*Q31 + 1 - 16 w/ sym. rounding ]
      acc1 = AE_MULF32R_LL(xin   , b0b0);
      AE_MULAF32R_LL(acc1, sx1sx0, b1b2);
      ...
      ae_int32_storeip(R0,castxcc(ae_int32, Pr),sz_i32);
      ae_int32_storeip(R1,castxcc(ae_int32, Pr),sz_i32);
    }

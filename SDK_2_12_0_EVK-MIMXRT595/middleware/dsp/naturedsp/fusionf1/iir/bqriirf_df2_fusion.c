...
DISCARD_FUN(size_t, bqriirf_df2_alloc, (int M))
DISCARD_FUN(bqriirf_df2_handle_t, bqriirf_df2_init, ( void * objmem, int M,
...
{
  NASSERT( M >= 0 );
  return sizeof(bqriirf_df2_t)+8*M*sizeof(float32_t)+7;
} // bqriirf_df2_alloc()

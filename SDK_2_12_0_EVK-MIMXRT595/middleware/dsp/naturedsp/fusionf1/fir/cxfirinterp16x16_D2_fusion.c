...
int cxfirinterp16x16_D2_proc( int16_t * restrict y,
                              int16_t * delayLine,
                              int       delayLen,
...

{
    ...
    { 
        ...
        for (d = 0; d < D; d++){
            ...
            t0 = AE_TRUNCA32X2F64S(q1r, q0r, 34);
            t1 = AE_TRUNCA32X2F64S(q3r, q2r, 34);
            ...
            t0 = AE_TRUNCA32X2F64S(q5r, q4r, 34);
            t1 = AE_TRUNCA32X2F64S(q7r, q6r, 34);
            dr0 = AE_ROUND16X4F32SASYM(t1, t0);
        ...
        { 
            ...
            t0 = AE_TRUNCA32X2F64S(q1i, q0i, 34);
            t1 = AE_TRUNCA32X2F64S(q3i, q2i, 34);
            ...
            t0 = AE_TRUNCA32X2F64S(q5i, q4i, 34);
            t1 = AE_TRUNCA32X2F64S(q7i, q6i, 34);
            di0 = AE_ROUND16X4F32SASYM(t1, t0);

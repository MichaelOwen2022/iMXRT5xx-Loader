...
#define sz_i32    sizeof(int32_t)
 ...
 int fir32x32_D3_proc( int32_t * restrict y,
                                  int32_t * delayLine,
                                  int32_t delayLen,
                          ...
                          int wrIx, int D, int N, int M )
{
  ...
  for ( n=0; n<(N>>2); n++ )
  {
    ...
    for ( m=0; m<(M>>2)+1; m++ )
    {
      ...
      AE_MULAF32R_HH(q1, d0, c0);
      AE_MULAF32R_LL(q1, d0, c0);
      AE_MULAF32R_HH(q1, d1, c1);
      AE_MULAF32R_LL(q1, d1, c1);

      AE_MULAF32R_HH(q2, t3, c0);
      AE_MULAF32R_LL(q2, t3, c0);
      AE_MULAF32R_HH(q2, t4, c1);
      AE_MULAF32R_LL(q2, t4, c1);

      AE_MULAF32R_HH(q3, d3, c0);
      AE_MULAF32R_LL(q3, d3, c0);
      AE_MULAF32R_HH(q3, d4, c1);
      AE_MULAF32R_LL(q3, d4, c1);

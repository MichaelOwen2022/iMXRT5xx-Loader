...
/*
  NatureDSP Signal Processing Library. FIR part
    Real data circular cross-correlation, 24x24-bit, no requirements on vectors 
                ...
                int N, int M )
{
    ...
    ASSERT( (int8_t *)s_ptr - (int8_t *)s <= 
            (int)FIR_XCORRA24X24_SCRATCH_SIZE( N, M ) );
    //----------------------------------------------------------------------------
    ...
    D = (      ae_f24x2 *)(x_buf+N + M-1);
    AE_S32F24_L_I( AE_ZERO24(), (      ae_f24 *)D, 0*sizeof(int32_t) );
    AE_S32F24_L_I( AE_ZERO24(), (      ae_f24 *)D, 1*sizeof(int32_t) );
    AE_S32F24_L_I( AE_ZERO24(), (      ae_f24 *)D, 2*sizeof(int32_t) );
    //----------------------------------------------------------------------------
    ...
    AE_S32F24_L_I( AE_ZERO24(), (      ae_f24 *)D, 1*sizeof(int32_t) );
    AE_S32F24_L_I( AE_ZERO24(), (      ae_f24 *)D, 2*sizeof(int32_t) );
    raw_corr24x24(r,x_buf,y_buf,N,(M+1)&~1);
} /* fir_xcorra24x24() */

...
int cxfirinterp16x16_D4_proc( int16_t * restrict y,
                              int16_t * delayLine,
                              int       delayLen,
                              ...
                              int wrIx, int D, int N, int M)
{
    ...
    for (n = 0; n < (N >> 3); n++)
    {
        ...
        __Pragma("loop_count min=4, max=4")
        for (d = 0; d < D; d++){
            D_tmp = D_wr_r;
            D_rd0 = D_wr_r;
            ...
            t0 = AE_TRUNCA32X2F64S(q1r, q0r, 35);
            t1 = AE_TRUNCA32X2F64S(q3r, q2r, 35);
            ...
            t0 = AE_TRUNCA32X2F64S(q5r, q4r, 35);
            t1 = AE_TRUNCA32X2F64S(q7r, q6r, 35);
            dr0 = AE_ROUND16X4F32SASYM(t1, t0);
        ...
        for (d = 0; d < D; d++)
        {
            ...
            t0 = AE_TRUNCA32X2F64S(q1i, q0i, 35);
            t1 = AE_TRUNCA32X2F64S(q3i, q2i, 35);
            ...
            t0 = AE_TRUNCA32X2F64S(q5i, q4i, 35);
            t1 = AE_TRUNCA32X2F64S(q7i, q6i, 35);
            di0 = AE_ROUND16X4F32SASYM(t1, t0);

...
int cxfirinterp16x16_D3_proc( int16_t * restrict y,
                              int16_t * delayLine,
                              int       delayLen,
                              ...
                              int wrIx, int D, int N, int M)
{
    ...
    for (n = 0; n < (N >> 3); n++)
    {
        ...
        __Pragma("loop_count min=3, max=3")
        for (d = 0; d < D; d++){
            D_tmp = D_wr_r;
            D_rd0 = D_wr_r;
            ...
            w0 = AE_ADD64S(q0r, q0r);
            w1 = AE_ADD64S(q1r, q1r);
            w2 = AE_ADD64S(q2r, q2r);
            w3 = AE_ADD64S(q3r, q3r);
            w4 = AE_ADD64S(q4r, q4r);
            w5 = AE_ADD64S(q5r, q5r);
            w6 = AE_ADD64S(q6r, q6r);
            w7 = AE_ADD64S(q7r, q7r);

            q0r = AE_ADD64S(w0, q0r);
            q1r = AE_ADD64S(w1, q1r);
            q2r = AE_ADD64S(w2, q2r);
            q3r = AE_ADD64S(w3, q3r);
            q4r = AE_ADD64S(w4, q4r);
            q5r = AE_ADD64S(w5, q5r);
            q6r = AE_ADD64S(w6, q6r);
            q7r = AE_ADD64S(w7, q7r);
        ...
        for (d = 0; d < D; d++)
        {
            ...
            w0 = AE_ADD64S(q0i, q0i);
            w1 = AE_ADD64S(q1i, q1i);
            w2 = AE_ADD64S(q2i, q2i);
            w3 = AE_ADD64S(q3i, q3i);
            w4 = AE_ADD64S(q4i, q4i);
            w5 = AE_ADD64S(q5i, q5i);
            w6 = AE_ADD64S(q6i, q6i);
            w7 = AE_ADD64S(q7i, q7i);

            q0i = AE_ADD64S(w0, q0i);
            q1i = AE_ADD64S(w1, q1i);
            q2i = AE_ADD64S(w2, q2i);
            q3i = AE_ADD64S(w3, q3i);
            q4i = AE_ADD64S(w4, q4i);
            q5i = AE_ADD64S(w5, q5i);
            q6i = AE_ADD64S(w6, q6i);
            q7i = AE_ADD64S(w7, q7i);

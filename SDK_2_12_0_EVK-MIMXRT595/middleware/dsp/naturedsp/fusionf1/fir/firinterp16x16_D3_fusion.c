...
int firinterp16x16_D3_proc( int16_t * restrict y,
                            int16_t * delayLine,
                            int       delayLen,
                            ...
                            int wrIx, int D, int N, int M)
{
    ...
    for (n = 0; n < (N >> 2); n++)
    {
        ...
        for (m = 0; m < (M >> 2) + 1; m++)
        {
            ...
            AE_MULAAAAQ16(q3, d12, c0);
            AE_MULAAAAQ16(q4, d12, c1);
            AE_MULAAAAQ16(q5, d12, c2);
        }
        ...
        for (m = 0; m < (M >> 2) + 1; m++)
        {
            ...
            AE_MULAAAAQ16(q7, d23, c1);
            AE_MULAAAAQ16(q8, d23, c2);

            AE_MULAAAAQ16(q9,  d34, c0);
            AE_MULAAAAQ16(q10, d34, c1);
            AE_MULAAAAQ16(q11, d34, c2);
        }
        ...
        w0 = AE_ADD64S(q8, q8);
        w1 = AE_ADD64S(q9, q9);
        w2 = AE_ADD64S(q10, q10);
        w3 = AE_ADD64S(q11, q11);

        q8  = AE_ADD64S(w0, q8);
        q9  = AE_ADD64S(w1, q9);
        q10 = AE_ADD64S(w2, q10);
        q11 = AE_ADD64S(w3, q11);

        t0 = AE_TRUNCA32X2F64S(q8, q9, 33);
        t1 = AE_TRUNCA32X2F64S(q10, q11, 33);
        AE_SA16X4_IP(AE_ROUND16X4F32SASYM(t0, t1), y_align, castxcc(ae_int16x4, Y));
    }

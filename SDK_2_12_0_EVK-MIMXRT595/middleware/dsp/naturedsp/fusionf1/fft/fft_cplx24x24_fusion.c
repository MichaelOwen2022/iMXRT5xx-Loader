...
#if 0 //__MNSD__
static const int32_t MSC_ALIGNED fft24x24_twd_r8[12] GCC_ALIGNED = {
    (int32_t)0x7fffff00,(int32_t)0x00000000,(int32_t)0x7fffff00,(int32_t)0x00000000,(int32_t)0x7fffff00,(int32_t)0x00000000,(int32_t)0x5a827900,(int32_t)0xA57D8700,(int32_t)0x00000000,(int32_t)0x80000000,(int32_t)0xa57d8600,(int32_t)0xA57D8700};
#endif 

#define FFT_BUTTERFLY_S0(_T,_step,_X,twd_step)  \
      {                                         \
...
#define FFT_BUTTERFLY_S0_LAST(_T,_step,_X,twd_step)  \
      {                                         \
        vT2 = AE_L32X2F24_I(p_twd, 8);          \
        vB3 = AE_SEL32_LH(vB3, vB3);            \
        vA1 = AE_SUB32S(vB0, vB1);              \
...
#define FFT_BUTTERFLY_S0_T0F(_T,_step)  \
      {                                         \
        vB3 = AE_SEL32_LH(vB3, vB3);            \
        vA1 = AE_SUB32S(vB0, vB1);              \
        vB0 = AE_ADD32S(vB0, vB1);              \
...
#define FFT_BUTTERFLY_S0_T0F_LAST(_T,_step)  \
      {                                         \
        vB3 = AE_SEL32_LH(vB3, vB3);            \
        vA1 = AE_SUB32S(vB0, vB1);              \
        vB0 = AE_ADD32S(vB0, vB1);              \
...
#define FFT_BUTTERFLY_S1(_T,_step,_X,twd_step)  \
      {                                         \
        vT2 = AE_L32X2F24_I(p_twd, 8);          \
        vB3 = AE_SEL32_LH(vB3, vB3);            \
        vA1 = AE_SUB32S(vB0, vB1);              \
...
#define FFT_BUTTERFLY_S1_LAST(_T,_step,_X,twd_step)  \
      {                                         \
        vT2 = AE_L32X2F24_I(p_twd, 8);          \
        vB3 = AE_SEL32_LH(vB3, vB3);            \
        vA1 = AE_SUB32S(vB0, vB1);              \
...
#define FFT_BUTTERFLY_S1_T1F(_T,_step)  \
      {                                         \
        vB3 = AE_SEL32_LH(vB3, vB3);            \
        vA1 = AE_SUB32S(vB0, vB1);              \
        vC0 = AE_ADD32S(vB0, vB1);              \
...
#define FFT_BUTTERFLY_S1_T1F_LAST(_T,_step)  \
      {                                         \
        vB3 = AE_SEL32_LH(vB3, vB3);            \
        vA1 = AE_SUB32S(vB0, vB1);              \
        vC0 = AE_ADD32S(vB0, vB1);              \
...
static void fft_cplx_24x24_lbut2 (int32_t *y, int32_t *x, int N)
{
...
static void fft_cplx_24x24_lbut4 (int32_t *y, int32_t *x, int N)
{
  ae_int32x2  vA0, vA1, vA2, vA3, vB0, vB1, vB2, vB3;
  ae_f24x2    vF1, vF2;
...
static int fft_cplx_24x24_core_s0(int32_t *y, int32_t *x, const tFftDescr* pDescr)
{
  ...
  { // first iteration for pre-scaling
    ...
    do 
    {
      FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ)
    } while(--lc);
    FFT_BUTTERFLY_S0_LAST(I, 2*4,XC,step_circ)
  ...
  while (stride > 16)
  {
    ...
    do 
    {
      ...
      FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ);
      FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ);
      FFT_BUTTERFLY_S0(X, step,XC,step_circ);
    ...
    } while(--lc);
    {
      ...
      FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ);
      FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ);
      FFT_BUTTERFLY_S0_LAST(X, step,XC,step_circ);
    } 
  ...
  if (stride == 16)
  {
    ...
    do 
    {
      ...
      FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ)
      FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ)
      FFT_BUTTERFLY_S0(X, step_fwd,XC,step_circ)
    } while(--lc);
    FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ)
    FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ)
    FFT_BUTTERFLY_S0(I, 2*4,XC,step_circ)
    FFT_BUTTERFLY_S0_LAST(X, step_fwd,XC,step_circ)
  ...
  if (stride == 8)
  {
    ...
    do 
    {
      ...
      FFT_BUTTERFLY_S0_T0F(I, 2*4 )
      vT1 = vT1_2; vT2 = vT2_2; vT3 = vT3_2;
      FFT_BUTTERFLY_S0_T0F(I, 14*4)
    } while(--lc);
    vT1 = vT1_1; vT2 = vT2_1; vT3 = vT3_1;
    FFT_BUTTERFLY_S0_T0F(I, 2*4 )
    vT1 = vT1_2; vT2 = vT2_2; vT3 = vT3_2;
    FFT_BUTTERFLY_S0_T0F_LAST(I, 14*4)
  ...
  {
    case 2:
      fft_cplx_24x24_lbut2(y, x, N);
      break;
    case 4:
      fft_cplx_24x24_lbut4(y, x, N);
      break;
  }
...
static int fft_cplx_24x24_core_s1(int32_t *y, int32_t *x, const tFftDescr* pDescr, int exp)
{
  ae_f24x2 * restrict p_x0, * restrict p_x1, * restrict p_x2, * restrict p_x3;
  const ae_f24x2 * restrict p_twd;
  const ae_int16 * restrict p_inc;
  ...
  { // first iteration for pre-scaling
    ...
    do 
    {
      FFT_BUTTERFLY_S1(I, 2*4,XC,step_circ)
    } while(--lc);
    FFT_BUTTERFLY_S1_LAST(I, 2*4,XC,step_circ)
  ...
  while (stride > 16)
  {
    ...
    do 
    {
      ...
      FFT_BUTTERFLY_S1(I, 2*4,XC,step_circ)
      FFT_BUTTERFLY_S1(I, 2*4,XC,step_circ)
      FFT_BUTTERFLY_S1(X, step,XC,step_circ)
    } while(--lc);
    {
      int step;
      ...
      FFT_BUTTERFLY_S1(I, 2*4,XC,step_circ)
      FFT_BUTTERFLY_S1(I, 2*4,XC,step_circ)
      FFT_BUTTERFLY_S1_LAST(X, step,XC,step_circ)
    } 
  ...
  if (stride==16)
  {
    ...
    do 
    {
      ...
      FFT_BUTTERFLY_S1(I, 2*4,XC,step_circ)
      FFT_BUTTERFLY_S1(I, 2*4,XC,step_circ)
      FFT_BUTTERFLY_S1(X, step_fwd,XC,step_circ)
    } while(--lc);
    AE_L16_IP(vS, p_inc, 2);
    vS = AE_SLAI16S(vS, 2);
    ...
    FFT_BUTTERFLY_S1(I, 2*4,XC,step_circ)
    FFT_BUTTERFLY_S1(I, 2*4,XC,step_circ)
    FFT_BUTTERFLY_S1_LAST(X, step_fwd,XC,step_circ)
  ...
  if (stride==8)
  {
    ...
    {
      vT1 = vT1_1; vT2 = vT2_1; vT3 = vT3_1;
      FFT_BUTTERFLY_S1_T1F(I, 2*4)
      vT1 = vT1_2; vT2 = vT2_2; vT3 = vT3_2;
      FFT_BUTTERFLY_S1_T1F(I, 14*4)
    } while(--lc);
    vT1 = vT1_1; vT2 = vT2_1; vT3 = vT3_1;
    FFT_BUTTERFLY_S1_T1F(I, 2*4)
    vT1 = vT1_2; vT2 = vT2_2; vT3 = vT3_2;
    FFT_BUTTERFLY_S1_T1F_LAST(I, 14*4)
...
static int fft_cplx_24x24_core_s3 (int32_t *y, int32_t *x,  const tFftDescr* pDescr)
{
  ae_f24x2 * restrict p_x0, * restrict p_x1, * restrict p_x2, * restrict p_x3;
  const ae_f24x2 * restrict p_twd;
  const ae_int16 * restrict p_inc;
  ...
  while (stride > 16)
  {
    ...
    do 
    {
      ...
      FFT_BUTTERFLY_S3(I, 2*4,XC,step_circ);
      FFT_BUTTERFLY_S3(I, 2*4,XC,step_circ);
      FFT_BUTTERFLY_S3(I, 2*4,XC,step_circ);
              ...
              int scalingOpt)
{
  ...
  {
    case 1:
      scale+=fft_cplx_24x24_core_s1(y, x, (const tFftDescr*)h, exp);
      break;
    case 3:
      scale+=fft_cplx_24x24_core_s3(y, x, (const tFftDescr*)h);
      break;
    default:
      scale+=fft_cplx_24x24_core_s0(y, x, (const tFftDescr*)h);
      break;
  }

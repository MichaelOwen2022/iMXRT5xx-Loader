...
DISCARD_FUN(void, cmtx_sub3x3f, (complex_float  * restrict z, const complex_float   *restrict x, const complex_float   *restrict y, int L))
#else
/* helper file */
#include "vec_sub.h"
/*-------------------------------------------------------------------------
...
void cmtx_sub3x3f(complex_float  * restrict z, const complex_float   *restrict x, const complex_float   *restrict y, int L)
{
  ...
  vec_subf((float32_t *)z, (float32_t *)x, (float32_t *)y, 2 * 3 * 3 * L);
} /* cmtx_sub3x3f() */
#endif

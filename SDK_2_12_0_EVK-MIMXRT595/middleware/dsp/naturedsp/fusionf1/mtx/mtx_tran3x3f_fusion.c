...
DISCARD_FUN(void, mtx_tran3x3f, (float32_t * restrict z, const float32_t *restrict x, int L))
#else
/*-------------------------------------------------------------------------
...
void mtx_tran3x3f(float32_t * restrict z, const float32_t *restrict x, int L)
{
  ...
  xtfloatx2 z0, z1, z2, z3, z4, z5, z6, z7, z8;
  ae_valign xa, za;
  ...
  for (l = 0; l<(L>>1); l++)
  {
    ...
    z0 = XT_SEL32_HL_SX2(x0, x1);
    z1 = XT_SEL32_HL_SX2(x3, x0);
    z2 = XT_SEL32_HL_SX2(x2, x3);
    z3 = XT_SEL32_HL_SX2(x1, x2);
    z4 = x4;
    z5 = XT_SEL32_HL_SX2(x6, x7);
    z6 = XT_SEL32_HL_SX2(x5, x6);
    z7 = XT_SEL32_HL_SX2(x8, x5);
    z8 = XT_SEL32_HL_SX2(x7, x8);
  ...
  if (L & 1)
  {
    ...
    XT_LASX2IP(x2, xa, px);
    XT_LASX2IP(x3, xa, px);
    XT_LSIP(x4, castxcc(xtfloat, px), 0);
    z0 = XT_SEL32_HL_SX2(x0, x1);
    z1 = XT_SEL32_HL_SX2(x3, x0);
    z2 = XT_SEL32_HL_SX2(x2, x3);
    z3 = XT_SEL32_HL_SX2(x1, x2);
    ...
    XT_SASX2IP(z3, za, pz);
    AE_SA64POS_FP(za, pz);
    XT_SSIP(x4, castxcc(xtfloat, pz), 0);
  }
} /* mtx_tran3x3f() */
#endif

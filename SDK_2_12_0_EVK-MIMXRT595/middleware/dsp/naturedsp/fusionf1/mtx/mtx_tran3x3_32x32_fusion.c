...
void mtx_tran3x3_32x32(int32_t   * restrict z, const int32_t   *restrict x, int L)
{
  ...
  ae_int32x2 z0, z1, z2, z3, z4, z5, z6, z7, z8;
  ae_valign xa, za;
  ...
  for (l = 0; l<(L>>1); l++)
  {
    ...
    AE_LA32X2_IP(x8, xa, px);

    z0 = AE_SEL32_HL(x0, x1);
    z1 = AE_SEL32_HL(x3, x0);
    z2 = AE_SEL32_HL(x2, x3);
    z3 = AE_SEL32_HL(x1, x2);
    z4 = x4;
    z5 = AE_SEL32_HL(x6, x7);
    z6 = AE_SEL32_HL(x5, x6);
    z7 = AE_SEL32_HL(x8, x5);
    z8 = AE_SEL32_HL(x7, x8);
  ...
  if (L&1)
  {
    ...
    AE_LA32X2_IP(x2, xa, px);
    AE_LA32X2_IP(x3, xa, px);
    AE_L32_IP(x4, castxcc(ae_int32, px), 0);
    z0 = AE_SEL32_HL(x0, x1);
    z1 = AE_SEL32_HL(x3, x0);
    z2 = AE_SEL32_HL(x2, x3);
    z3 = AE_SEL32_HL(x1, x2);
    z4 = AE_SEL32_HL(x4, x4);
    AE_SA32X2_IP(z0, za, pz);
    AE_SA32X2_IP(z1, za, pz);
    AE_SA32X2_IP(z2, za, pz);
    AE_SA32X2_IP(z3, za, pz);
    AE_SA64POS_FP(za, pz);
    AE_S32_L_I(z4,(ae_int32 *)pz,0);
  }
} /* mtx_tran3x3_32x32() */

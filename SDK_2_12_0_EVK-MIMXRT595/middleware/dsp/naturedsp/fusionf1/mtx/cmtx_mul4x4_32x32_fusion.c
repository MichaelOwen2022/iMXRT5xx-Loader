...
void cmtx_mul4x4_32x32(complex_fract32 * restrict z, const complex_fract32 *restrict x, const complex_fract32 *restrict y, int rsh, int L)
{
  ...
  const ae_int32x2    *  restrict py1 = (const ae_int32x2    *)(y+4);
  const ae_int32x2    *  restrict py2 = (const ae_int32x2    *)(y+8);
  const ae_int32x2    *  restrict py3 = (const ae_int32x2    *)(y+12);
  ...
  for (l = 0; l<L; l++,y+=4*4)
  {
    for (m=0;m<4;m++)
    {
      ...
      py1 = (const ae_int32x2    *)(y + 4);
      py2 = (const ae_int32x2    *)(y + 8);
      py3 = (const ae_int32x2    *)(y + 12);
      ...
      for (n = 0; n<4; n++)
      {
        ...
        AE_MULAF32R_HH(A0, vx3, vy3);
        AE_MULSF32R_LL(A0, vx3, vy3);
        ...
        AE_MULAF32R_HL(A1, vx3, vy3);
        AE_MULAF32R_LH(A1, vx3, vy3);

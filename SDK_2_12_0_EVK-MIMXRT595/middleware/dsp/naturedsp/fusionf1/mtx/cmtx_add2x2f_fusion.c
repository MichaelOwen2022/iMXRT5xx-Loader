...
DISCARD_FUN(void, cmtx_add2x2f, (complex_float  * restrict z, const complex_float   *restrict x, const complex_float   *restrict y, int L))
#else
/*-------------------------------------------------------------------------
...
void cmtx_add2x2f(complex_float  * restrict z, const complex_float   *restrict x, const complex_float   *restrict y, int L)
{
  ...
  vec_addf((float32_t *)z, (float32_t *)x, (float32_t *)y, 2 * 2 * 2 * L);
} /* cmtx_add2x2f() */
#endif

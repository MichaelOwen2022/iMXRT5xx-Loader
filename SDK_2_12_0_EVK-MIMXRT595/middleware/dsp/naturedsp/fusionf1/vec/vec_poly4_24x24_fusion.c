...
void vec_poly4_24x24 (f24 * restrict z, const f24 * restrict x, const f24 * restrict c, int lsh, int N )
{
    ...
    ae_f24x2    c0f, c1f, c2f, c3f, c4f, s, vxf;
    ae_f32x2 t;
    ...
    z_align = AE_ZALIGN64();
    AE_L32F24_IP(c0f, pc, sizeof(*pc));
    AE_L32F24_IP(c1f, pc, sizeof(*pc));
    AE_L32F24_IP(c2f, pc, sizeof(*pc));
    AE_L32F24_IP(c3f, pc, sizeof(*pc));
    AE_L32F24_IP(c4f, pc, sizeof(*pc));
    WUR_AE_SAR(lsh);
    for (n=0; n<(N&~1); n+=2)
    { 
        AE_LA32X2F24_IP(vxf, x_align, px); 
        t=c3f; AE_MULAFP24X2RA(t, vxf, c4f); s=AE_SAT24S(t);
        t=c2f; AE_MULAFP24X2RA(t, vxf, s  ); s=AE_SAT24S(t);
        t=c1f; AE_MULAFP24X2RA(t, vxf, s  ); s=AE_SAT24S(t);
        t=c0f; AE_MULAFP24X2RA(t, vxf, s  ); 
        t=AE_SLAS32S(t);
        s=AE_SAT24S(t);

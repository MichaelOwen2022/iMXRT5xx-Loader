...
void vec_antilog2_24x24 (int32_t * restrict y, const int32_t* restrict x, int N)
{
    int n;
    ...
    for (n=0; n<(N&~1); n+=2)
    {
        ...
        E=AE_SRAI32(X,17);
        E=AE_SUB32(E,15);
        X=AE_AND32(X,AE_MOVDA32X2(0x1ffff,0x1ffff));
        X=AE_SUB32(X,AE_MOVDA32X2(0x20000,0x20000));
        X=AE_SLLI32(X,14);

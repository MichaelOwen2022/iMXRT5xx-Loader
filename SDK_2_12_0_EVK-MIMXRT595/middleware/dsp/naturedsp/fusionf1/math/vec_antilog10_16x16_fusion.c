...
void vec_antilog10_16x16 (int16_t * restrict y, const int16_t * restrict x, int N)
{
    ...
    for (n=0; n<(N&~3); n+=4)
    {
        /* load, multiply by log2(10) and convert to Q18, take exponent */
        ...
        X0=AE_SRAI32(X0,8);
        X1=AE_SRAI32(X1,8);
        X0=AE_MULFP24X2RA(AE_MOVF24X2_FROMINT32X2(X0),6966588);
        X1=AE_MULFP24X2RA(AE_MOVF24X2_FROMINT32X2(X1),6966588);
        E0=AE_ADD32(AE_SRAI32(X0,18),1);
        E1=AE_ADD32(AE_SRAI32(X1,18),1);
        X0=AE_SUB32(AE_SRLI32(AE_SLAI32(X0,14),9),0x800000);
        X1=AE_SUB32(AE_SRLI32(AE_SLAI32(X1,14),9),0x800000);

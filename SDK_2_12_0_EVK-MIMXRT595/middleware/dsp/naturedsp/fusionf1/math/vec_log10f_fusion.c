...
void vec_log10f     (float32_t * restrict y,const float32_t * restrict x, int N)
{
  ...
  */
  ...
  static const uint32_t TAB[] = { 0x00800000, 0x4b000000, 0x3f3504f3, 0x007FFFFF, 0x3F000000, 
     0x7fc00000, 0x7f800000, 0xff800000 }; /* qNaN, plusInf, minusInf */
    ...
    */
    {
      ...
      Y_rd = (xtfloat*)( (uintptr_t)y + blkIx*blkSize*sz_f32 );
      Y_wr = (xtfloat*)( (uintptr_t)y + blkIx*blkSize*sz_f32 );
        WUR_AE_CBEGIN0((uintptr_t)(Y_rd));
        WUR_AE_CEND0  ((uintptr_t)(Y_rd)+blkLen*sz_f32);
      POLY_TBL = (xtfloat*)(log10f_tbl + 1);
      pT=(const xtfloat*) (TAB+5);
      /* Pre-load coefficients */
      cf0 = XT_LSI(POLY_TBL, -1 * sz_f32);
      cf1 = XT_LSI(POLY_TBL, 0 * sz_f32);
      cf2 = XT_LSI(POLY_TBL, 1 * sz_f32);
      XT_LSXC(fr, Y_rd, +sz_f32);
      for ( n=0; n<(blkLen>>1); n++ )
      {
        ...
        cf3 = XT_LSI(POLY_TBL, 2 * sz_f32);
        cf4 = XT_LSI(POLY_TBL, 3 * sz_f32);
        cf5 = XT_LSI(POLY_TBL, 4 * sz_f32);
        cf6 = XT_LSI(POLY_TBL, 5 * sz_f32);
        cf7 = XT_LSI(POLY_TBL, 6 * sz_f32);
        cf8 = XT_LSX(POLY_TBL, 7 * sz_f32);
        ...
        */
        ...
        t = XT_FLOAT_S(ex, 2);
        XT_MADD_S(t, g, fr); XT_MADD_S(t, XT_FLOAT_S(ex, 2), _4log10_2minus1.f);
        y0 = (xtfloatx2)(t);
        ...
        */
        ...
        {
          pt1=XT_AE_MOVXTFLOATX2_FROMINT32X2(AE_MOVINT32X2_FROMINT32(((const ae_int32*)pT)[0]));
          pt3=XT_AE_MOVXTFLOATX2_FROMINT32X2(AE_MOVINT32X2_FROMINT32(((const ae_int32*)pT)[2]));
          pt2=XT_AE_MOVXTFLOATX2_FROMINT32X2(AE_MOVINT32X2_FROMINT32(((const ae_int32*)pT)[1]));
          b_ultz = XT_ULT_S( x0, XT_CONST_S(0) );
          b_eqz  = XT_OEQ_S( x0, XT_CONST_S(0) );
          b_inf  = XT_OEQ_S( x0, pT[1] );

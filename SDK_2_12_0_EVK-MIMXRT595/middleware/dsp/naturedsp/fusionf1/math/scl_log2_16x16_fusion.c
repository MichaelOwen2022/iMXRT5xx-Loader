...
int16_t scl_log2_16x16 (int16_t x)
{
    ...
    Z=AE_L32_I(ptbl,16);
    /* apply original exponent */
    f=AE_SLAI32(E,18);AE_MULAFP24X2RA(f,AE_MOVF24X2_FROMINT32X2(Y ),AE_MOVF24X2_FROMINT32X2(Z)); Y=f;
    Y=AE_SLAI24S(AE_MOVF24X2_FROMINT32X2(Y),2);  
    /* save results */

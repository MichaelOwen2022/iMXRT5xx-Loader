...
int16_t scl_cosine16x16 (int16_t x)
{
    ...
    Y=costblq23[0];        
    f=costblq23[1];          AE_MULAFP24X2RA(f,AE_MOVF24X2_FROMINT32X2(Y),X2); Y=f;
    f=costblq23[2];          AE_MULAFP24X2RA(f,AE_MOVF24X2_FROMINT32X2(Y),X2); Y=f;
    f=AE_SUB32(0x800000,X2); AE_MULAFP24X2RA(f,AE_MOVF24X2_FROMINT32X2(Y),X2); Y=f;
    /* apply sign */
    AE_MOVT32X2(Y,AE_NEG32(Y),big);

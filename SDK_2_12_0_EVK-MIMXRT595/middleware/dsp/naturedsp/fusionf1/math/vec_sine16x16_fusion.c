...
{
    xtbool2 big0,big1;
    ae_int16x4 x0,x1,x2,z0,_0x4000;
    ...
    _0x800000=0x800000;
    _0x4000=AE_MOVINT16X4_FROMINT32X2(AE_MOVDA32X2(0x40004000,0x40004000));
...
#else
{
    ...
    for (n=0; n<(N&~3); n+=4)
    {
        ...
        sx0=AE_LT32(X0,0);
        sx1=AE_LT32(X1,0);
        X0=AE_SRLI32(AE_SLAI32(X0,1),8);
        X1=AE_SRLI32(AE_SLAI32(X1,1),8);
        X0=AE_SUB24S(_0x800000,AE_ABS32(AE_SUB32(X0,_0x800000)));
        X1=AE_SUB24S(_0x800000,AE_ABS32(AE_SUB32(X1,_0x800000)));
        /* compute polynomial */
        X20=AE_MOVF24X2_FROMINT32X2(AE_MULFP24X2RA(AE_MOVF24X2_FROMINT32X2(X0),AE_MOVF24X2_FROMINT32X2(X0)));

...
float32_t scl_lognf( float32_t x )
{
  ...
  XT_MADDN_S( cf1, cf0, fr0 ); cf0 = cf1;
  XT_MADDN_S( cf3, cf2, fr0 ); cf1 = cf3;
  XT_MADDN_S( cf5, cf4, fr0 ); cf2 = cf5;
  XT_MADDN_S( cf7, cf6, fr0 ); cf3 = cf7;

  XT_MADDN_S( cf1, cf0, fr1 ); cf0 = cf1;
  XT_MADDN_S( cf3, cf2, fr1 ); cf1 = cf3;

  XT_MADDN_S( cf1, cf0, fr2 ); g = cf1;

  /* 
   * Compute y = fr*g + ex*ln(2)
   */

  t = XT_CONST_S(1); XT_MSUBN_S( t, g, fr0 ); g = t;
  XT_MSUBN_S( y0, g, fr0 );

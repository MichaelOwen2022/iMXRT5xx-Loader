...
void vec_antilog2_16x16 (int16_t * restrict y, const int16_t * restrict x, int N)
{
    ...
    for (n=0; n<(N&~3); n+=4)
    {
        ...
        E0=AE_ADD32(AE_SRAI32(X0,28),1);
        E1=AE_ADD32(AE_SRAI32(X1,28),1);
        X0=AE_SUB32(AE_SRLI32(AE_SLAI32(X0,4),9),0x800000);
        X1=AE_SUB32(AE_SRLI32(AE_SLAI32(X1,4),9),0x800000);

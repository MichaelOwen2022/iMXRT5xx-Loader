...
float32_t scl_log2f (float32_t x)
{
  ...
  cf0 = log2f_tbl[0].f; cf1 = log2f_tbl[1].f;
  cf2 = log2f_tbl[2].f; cf3 = log2f_tbl[3].f;
  cf4 = log2f_tbl[4].f; cf5 = log2f_tbl[5].f;
  cf6 = log2f_tbl[6].f; cf7 = log2f_tbl[7].f;
  cf8 = log2f_tbl[8].f; cf9 = log2f_tbl[9].f;

  XT_MADDN_S( cf1, cf0, fr0 );
  XT_MADDN_S( cf3, cf2, fr0 );
  XT_MADDN_S( cf5, cf4, fr0 );
  XT_MADDN_S( cf7, cf6, fr0 );
  XT_MADDN_S( cf9, cf8, fr0 );

  g = cf1;
  XT_MADDN_S( cf3, g, fr2 ); g = cf3;
  XT_MADDN_S( cf5, g, fr2 ); g = cf5;
  XT_MADDN_S( cf7, g, fr2 ); g = cf7;
  XT_MADDN_S( cf9, g, fr2 ); g = cf9;

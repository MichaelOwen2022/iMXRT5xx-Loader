    ...
    */
    {
      ...
      cf0 = XT_LSI(POLY_TBL, -2 * sz_f32);
      cf1 = XT_LSI(POLY_TBL, -1 * sz_f32);
      cf2 = XT_LSI(POLY_TBL, 0 * sz_f32);
      cf3 = XT_LSI(POLY_TBL, 1 * sz_f32);
      for ( n=0; n<(blkLen>>1); n++ )
      {
        ...
        cf4 = XT_LSI(POLY_TBL, 2 * sz_f32);
        cf5 = XT_LSI(POLY_TBL, 3 * sz_f32);
        cf6 = XT_LSI(POLY_TBL, 4 * sz_f32);
        cf7 = XT_LSI(POLY_TBL, 5 * sz_f32);
        cf8 = XT_LSI(POLY_TBL, 6 * sz_f32);
        cf9 = XT_LSI(POLY_TBL, 7 * sz_f32);
        /*

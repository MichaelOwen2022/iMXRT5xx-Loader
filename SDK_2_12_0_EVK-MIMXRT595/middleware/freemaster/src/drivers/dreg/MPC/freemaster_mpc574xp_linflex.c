...
#define FMSTR_SERIAL_MPC57XP_LINFLEX_ID 1

#if (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_MPC57XP_LINFLEX_ID)
#if !(FMSTR_DISABLE) 
...
#endif /* !(FMSTR_DISABLE) */ 
#endif /* (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_MPC57XP_LINFLEX_ID) */

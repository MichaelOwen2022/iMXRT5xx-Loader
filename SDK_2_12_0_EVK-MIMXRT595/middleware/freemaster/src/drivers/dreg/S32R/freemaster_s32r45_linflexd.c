...
#define FMSTR_SERIAL_S32R45_LINFLEXD_ID 1

#if (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32R45_LINFLEXD_ID)
#if !(FMSTR_DISABLE)

#include "freemaster_serial.h"
#include "freemaster_s32r45_linflexd.h"
...
static FMSTR_BOOL _FMSTR_S32R45_Init(void);
static void _FMSTR_S32R45_EnableTransmit(FMSTR_BOOL enable);
static void _FMSTR_S32R45_EnableReceive(FMSTR_BOOL enable);
static void _FMSTR_S32R45_EnableTransmitInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32R45_EnableTransmitCompleteInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32R45_EnableReceiveInterrupt(FMSTR_BOOL enable);
static FMSTR_BOOL _FMSTR_S32R45_IsTransmitRegEmpty(void);
static FMSTR_BOOL _FMSTR_S32R45_IsReceiveRegFull(void);
static FMSTR_BOOL _FMSTR_S32R45_IsTransmitterActive(void);
static void _FMSTR_S32R45_PutChar(FMSTR_BCHR ch);
static FMSTR_BCHR _FMSTR_S32R45_GetChar(void);
static void _FMSTR_S32R45_Flush(void);
...
const FMSTR_SERIAL_DRV_INTF FMSTR_SERIAL_S32R45_LINFLEXD =
{
    .Init                       = _FMSTR_S32R45_Init,
    .EnableTransmit             = _FMSTR_S32R45_EnableTransmit,
    .EnableReceive              = _FMSTR_S32R45_EnableReceive,
    .EnableTransmitInterrupt    = _FMSTR_S32R45_EnableTransmitInterrupt,
    .EnableTransmitCompleteInterrupt= _FMSTR_S32R45_EnableTransmitCompleteInterrupt,
    .EnableReceiveInterrupt     = _FMSTR_S32R45_EnableReceiveInterrupt,
    .IsTransmitRegEmpty         = _FMSTR_S32R45_IsTransmitRegEmpty,
    .IsReceiveRegFull           = _FMSTR_S32R45_IsReceiveRegFull,
    .IsTransmitterActive        = _FMSTR_S32R45_IsTransmitterActive,
    .PutChar                    = _FMSTR_S32R45_PutChar,
    .GetChar                    = _FMSTR_S32R45_GetChar,
    .Flush                      = _FMSTR_S32R45_Flush,
};
...
#endif /* !(FMSTR_DISABLE) */
#endif /* (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32R45_LINFLEXD_ID) */

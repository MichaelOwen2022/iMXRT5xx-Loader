...
#define FMSTR_SERIAL_S32G274A_LINFLEXD_ID 1

#if (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32G274A_LINFLEXD_ID)
#if !(FMSTR_DISABLE)
...
#endif /* !(FMSTR_DISABLE) */
#endif /* (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32G274A_LINFLEXD_ID) */

...
#define FMSTR_CAN_56F800E_FLEXCAN_ID 1

#if (FMSTR_MK_IDSTR(FMSTR_CAN_DRV) == FMSTR_CAN_56F800E_FLEXCAN_ID)
...
#endif /* (!(FMSTR_DISABLE)) */
#endif /* (FMSTR_MK_IDSTR(FMSTR_CAN_DRV) == FMSTR_CAN_56F800E_FLEXCAN) */

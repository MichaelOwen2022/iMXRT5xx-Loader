...
#define TWO_OUTPUT_FILES
char	inputFilename[]         = "\\..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
char	outputFilename[]		= "\\..\\..\\OUT_ARMDS\\EAP_demo_48000_2ch_short_AllEffectOff_OUT_LB_32b_EQNB_ON.pcm";
char	outputFilename2[]		= "\\..\\..\\OUT_ARMDS\\EAP_demo_48000_2ch_short_AllEffectOff_OUT_HB_32b.pcm";
char	PSAOutputFilename[]		= "..\\..\\OUT_ARMDS\\1EAP_demo_48000_2ch_PSA_AllOff_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_AllEffectOff_AVL_32b.pcm";
#endif
#endif

#ifdef EAP_PARAM_VOICE_ENHANCER
char	inputFilename[]			= "..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
char	outputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_VoiceEnhancer_OUT_32b.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_VoiceEnhancer_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_VoiceEnhancer_AVL_32b.pcm";
#endif
#endif

#ifdef EAP_PARAM_MUSIC_ENHANCER_RMSLIMITER
char	inputFilename[]			= "..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
char	outputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_MusicEnhancerRMSLimiter_OUT_32b.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_MusicEnhancerRMSLimiter_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_MusicEnhancerRMSLimiter_AVL_32b.pcm";
#endif
#endif

#ifdef EAP_PARAM_AUTO_VOLUME_LEVELER
char	inputFilename[]			= "..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
char	outputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_AutoVolumeLeveler_OUT_32b.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_AutoVolumeLeveler_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_AutoVolumeLeveler_AVL_32b.pcm";
#endif
#endif

#ifdef EAP_PARAM_CONCERTSOUND
char	inputFilename[]			= "..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
char	outputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_ConcertSound_OUT_32b.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_ConcertSound_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_ConcertSound_AVL_32b.pcm";
#endif
#endif

#ifdef EAP_PARAM_LOUDNESS_MAXIMISER
char	inputFilename[]			= "..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
char	outputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_LoudnessMaximiser_OUT_32b.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_LoudnessMaximiser_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_LoudnessMaximiser_AVL_32b.pcm";
#endif
#endif

#ifdef EAP_PARAM_CUSTOM
char	inputFilename[]			= "..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
char	outputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_Custom_OUT_32b.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_Custom_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_Custom_AVL_32b.pcm";
#endif
#endif

#ifdef EAP_PARAM_TONE_GENERATOR
char	inputFilename[]			= "..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
char	outputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_ToneGenerator_OUT_32b.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_ToneGenerator_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_ToneGenerator_AVL_32b.pcm";
#endif
#endif
...
#define TWO_OUTPUT_FILES
char	inputFilename[]			= "\\..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
char	outputFilename[]		= "\\..\\..\\OUT_ARMDS\\EAP_demo_48000_2ch_short_AllTestOn_OUT_LB_32b.pcm";
char	outputFilename2[]       = "\\..\\..\\OUT_ARMDS\\EAP_demo_48000_2ch_short_AllTestOn_OUT_HB_32b.pcm";
char	PSAOutputFilename[]		= "\\..\\..\\OUT_ARMDS\\EAP_demo_48000_2ch_short_AllTestOn_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_AllTestOn_AVL_32b.pcm";
#endif
#endif
#ifdef EAP_PARAM_CROSSOVER_FOR_SUBWOOFER
#define TWO_OUTPUT_FILES /*In case of Crossover Filtering we will use 2 output files*/
char	inputFilename[] = "..\\..\\In\\EAP_demo_48000_2ch_short_32b.pcm";
/* First output file for Low band and second for High Band*/
char	outputFilename[] = "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_CrossoverForSubwoofer_LB_32b.pcm";
char	outputFilename2[] = "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_CrossoverForSubwoofer_HB_32b.pcm";
char	PSAOutputFilename[] = "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_CrossoverForSubwoofer_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[] = "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_CrossoverForSubwoofer_AVL_32b.pcm";
#endif
#endif
...
char	inputFilename[] = "..\\..\\In\\Sample_BeeMoved_96kHz32bit.pcm";
/* First output file for Low band and second for High Band*/
char	outputFilename[] = "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_Crossover2waySpeakers_LB_32b.pcm";
char	outputFilename2[] = "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_Crossover2waySpeakers_HB_32b.pcm";
char	PSAOutputFilename[] = "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_Crossover2waySpeakers_PSA_32b.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[] = "..\\..\\Out_VISUAL\\EAP_demo_48000_2ch_short_Crossover2waySpeakers_AVL_32b.pcm";
#endif
#endif
...
int eapTest (void)
{
    ...
    */
    ...
    LVM_INT32               IOBuffer[LVM_MAX_NUM_CHANNELS * MAX_INTERNAL_BLOCKSIZE + 1] = {0};   				 /* Read buffer for the samples */
    LVM_INT32   			*pReadBuffer 									  = &IOBuffer[0];
    ...
    LVM_INT32               OutBuffer[LVM_MAX_NUM_CHANNELS * MAX_INTERNAL_BLOCKSIZE + 1]  	     = {0};        		     /* Output buffer for the samples, output is always stereo */
	LVM_INT32   			*pWriteBuffer= &OutBuffer[0];											 /* Output buffer for the samples, output is always stereo */	
#ifdef TWO_OUTPUT_FILES
	LVM_INT32               OutBuffer2[LVM_MAX_NUM_CHANNELS * MAX_INTERNAL_BLOCKSIZE + 1] = { 0 };
	LVM_INT32   			*pWriteBuffer2 = &OutBuffer2[0];
#endif // TWO_OUTPUT_FILES	
    LVM_INT16               InplaceProcessing_Flag 							 = 1;					 /* 1 for in place processing then OutBuffer can be removed */
    LVM_UINT32              SampleRate 					= 0;	 	/* sample rate in Hz */
    ...
    // scratch
    LVM_INT32               *pScratchBase = LVM_NULL;
	...
	LVM_INT32 *pbufferTable[2];
	pbufferTable[0] = pWriteBuffer;
	pbufferTable[1] = LVM_NULL;
	LVM_INT32				**pToWriteBuffer = pbufferTable; /* Table of pointer for process */
    ...
    *******************************************************************************/
    ...
    {
        printf("Get Memory Table error - out of range");
        return -1;
    }
    ...
    {
        /* Log the memory size */
        //printf(" Memory region %d, size %d in Bytes\n",(LVM_INT16)i,(LVM_UINT32)EAP_MemTab.Region[i].Size);
    ...
    *******************************************************************************/
    do
    {
        ...
        if(EAP_eventPending_flag==LVM_TRUE)
        {
			 ...
			 */
			// sampling rate
			if (pEAP_ControlParams->SampleRate == LVM_FS_8000)	{SampleRate = 8000;} // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			if (pEAP_ControlParams->SampleRate == LVM_FS_11025)	{SampleRate = 11025;} // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			if (pEAP_ControlParams->SampleRate == LVM_FS_12000)	{SampleRate = 12000;} // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			if (pEAP_ControlParams->SampleRate == LVM_FS_16000)	{SampleRate = 16000;} // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			if (pEAP_ControlParams->SampleRate == LVM_FS_22050)	{SampleRate = 22050;} // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			if (pEAP_ControlParams->SampleRate == LVM_FS_24000)	{SampleRate = 24000;} // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			if (pEAP_ControlParams->SampleRate == LVM_FS_32000)	{SampleRate = 32000;} // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			if (pEAP_ControlParams->SampleRate == LVM_FS_44100)	{SampleRate = 44100;} // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			if (pEAP_ControlParams->SampleRate == LVM_FS_48000)	{SampleRate = 48000;} // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			if (pEAP_ControlParams->SampleRate == LVM_FS_96000) {SampleRate = 96000; } // 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000,96000
			// Input data format
        ...
        */
		...
		{
			ReadSamplesPerChannel = 384;//(SampleRate * LVM_FRAME_SIZE_MS) / 1000;
		 ...
		 */
		ReadFromFileSample = (LVM_UINT16)fread( pReadBuffer , sizeof(LVM_INT32), ReadSamplesTotal, AUDIO_INPUT_FILE );
		...
		else // else enough sample to call LVM_Process
		{
			...
			fwrite(pToWriteBuffer[0] , sizeof(LVM_INT32), (LVM_INT32)WriteSamplesTotal, AUDIO_OUTPUT_FILE );
#ifdef TWO_OUTPUT_FILES
			if (pEAP_ControlParams->XO_OperatingMode == LVM_MODE_ON)
				fwrite(pToWriteBuffer[1], sizeof(LVM_INT32), (LVM_INT32)WriteSamplesTotal, AUDIO_OUTPUT_FILE2);
#endif/*TWO_OUTPUT_FILES*/
			...
			*/
			...
			/******************************************************************************
	    	  ...
	    	  As an example:
	    	  	  - read AVL gain
	    	  	  - duplicate value for enabling comparison with output audio _32b.pcm
			...
			******************************************************************************/
			...
			for (i=0;i<ReadSamplesPerChannel;i++) // duplicate to enable comparison with output audio _32b.pcm
			{

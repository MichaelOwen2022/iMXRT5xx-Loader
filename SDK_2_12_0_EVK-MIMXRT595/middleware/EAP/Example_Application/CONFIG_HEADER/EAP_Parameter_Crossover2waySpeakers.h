...
#ifndef EAP_PARAMETER_CROSSOVER_2_WAY_SPEAKER
#define EAP_PARAMETER_CROSSOVER_2_WAY_SPEAKER
/*******************************************************************/
/* Include */
/*******************************************************************/


LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_Crossover2WaySpeaker[LVM_EQNB_MAX_BANDS_NBR] = {
																			...
																			{0,0,0},
																			{0,0,0} };
LVM_EQNB_BandDef_t EQNB_BandDefs_ProductEq1_Crossover2WaySpeaker[LVM_EQNB_MAX_BANDS_NBR] = {
...
LVM_HeadroomBandDef_t HeadroomBandDef_Crossover2WaySpeaker[LVM_HEADROOM_MAX_NBANDS] =
...
LVM_HeadroomParams_t HeadroomParams_Crossover2WaySpeaker = {
	.Headroom_OperatingMode = LVM_HEADROOM_OFF,  						/* Headroom Control On/Off */
	.pHeadroomDefinition = &HeadroomBandDef_Crossover2WaySpeaker[0],	/* Headroom band definition */
 ...
 *
 */
LVM_InstParams_t InstParams_Crossover2WaySpeaker = {
	/* General */
	.BufferMode		  = LVM_MANAGED_BUFFERS,				/* Buffer management mode */
	.MaxBlockSize 	  = 1024,      	    					/* Maximum processing block size  */
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_Crossover2WaySpeaker = {
	/* General parameters */
...
.pEQNB_BandDefinition = &EQNB_BandDefs_UserEq1_Crossover2WaySpeaker[0],// EQ band configuration
#endif /* ALGORITHM_EQNB */
	...
	.pPR_EQNB_BandDefinition = &EQNB_BandDefs_ProductEq1_Crossover2WaySpeaker[0],// EQ band configuration
...
#ifdef ALGORITHM_XO
	.XO_OperatingMode = LVM_MODE_ON,					// LVM_MODE_ON or LVM_MODE_OFF
	.XO_cutoffFrequency = 3500,							//Cutoff frequency in Hz (range  = [60 Hz - 6 000 Hz])
#endif // ALGORITHM_XO

};

#endif // end    EAP_PARAMETER_CROSSOVER_2_WAY_SPEAKER

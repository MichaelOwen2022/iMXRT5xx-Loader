...
#ifndef EAP_PARAMETER_CROSSOVER_FOR_SUBWOOFER
#define EAP_PARAMETER_CROSSOVER_FOR_SUBWOOFER
/*******************************************************************/
/* Include */
/*******************************************************************/
...
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_CrossoverForSubwoofer[LVM_EQNB_MAX_BANDS_NBR] = {
																			...
																			{0,0,0},
																			{0,0,0} };
LVM_EQNB_BandDef_t EQNB_BandDefs_ProductEq1_CrossoverForSubwoofer[LVM_EQNB_MAX_BANDS_NBR] = {
...
LVM_HeadroomBandDef_t HeadroomBandDef_CrossoverForSubwoofer[LVM_HEADROOM_MAX_NBANDS] =
...
LVM_HeadroomParams_t HeadroomParams_CrossoverForSubwoofer = {
	.Headroom_OperatingMode = LVM_HEADROOM_OFF,  							/* Headroom Control On/Off */
	.pHeadroomDefinition = &HeadroomBandDef_CrossoverForSubwoofer[0],		/* Headroom band definition */
 ...
 *
 */
LVM_InstParams_t InstParams_CrossoverForSubwoofer = {
	/* General */
...
LVM_ControlParams_t	ControlParamSet_CrossoverForSubwoofer = {
	...
	.pEQNB_BandDefinition = &EQNB_BandDefs_UserEq1_CrossoverForSubwoofer[0],// EQ band configuration
#endif /* ALGORITHM_EQNB */
	...
	.pPR_EQNB_BandDefinition = &EQNB_BandDefs_ProductEq1_CrossoverForSubwoofer[0],// EQ band configuration
...
#endif // end    EAP_PARAMETER_CROSSOVER_FOR_SUBWOOFER

...
#ifndef EAP_PARAMETER_VOICE_ENHANCER
#define EAP_PARAMETER_VOICE_ENHANCER
/*******************************************************************/
/* Include */
/*******************************************************************/
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_voiceEnhancer[LVM_EQNB_MAX_BANDS_NBR] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_ProductEq1_voiceEnhancer[LVM_EQNB_MAX_BANDS_NBR] = {
 ...
 *
 */
LVM_InstParams_t InstParams_voiceEnhancer = {
	/* General */
...
LVM_HeadroomBandDef_t HeadroomBandDef_voiceEnhancer[LVM_HEADROOM_MAX_NBANDS]  = { {20,4999,3},    		/* Limit_Low, Limit_High, Headroom_Offset */
																		          {5000,24000,5},
																		          {0,0,0},
																		          {0,0,0},
																		          {0,0,0} };

LVM_HeadroomParams_t HeadroomParams_voiceEnhancer = {
		.Headroom_OperatingMode	= LVM_HEADROOM_ON,  					/* Headroom Control On/Off */
		.pHeadroomDefinition	= &HeadroomBandDef_voiceEnhancer[0],	/* Headroom band definition */
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_voiceEnhancer = {
	/* General parameters */
	...
	.pEQNB_BandDefinition			= &EQNB_BandDefs_UserEq1_voiceEnhancer[0],// EQ band configuration
#endif /* ALGORITHM_EQNB */
	...
	.pPR_EQNB_BandDefinition		= &EQNB_BandDefs_ProductEq1_voiceEnhancer[0],// EQ band configuration

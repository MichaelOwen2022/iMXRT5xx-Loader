...
#ifndef EAP_PARAMETER_VOICE_ENHANCER_LOWMIPS
#define EAP_PARAMETER_VOICE_ENHANCER_LOWMIPS
/*******************************************************************/
/* Include */
/*******************************************************************/
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_voiceEnhancer_lowMIPS[LVM_EQNB_MAX_BANDS_NBR] 	= {
																  {-10,100,100},   	// gain(dB), freq(Hz) , Qfactor *100
																  {1,900,100},
																  {-3,3999,80},
																  {0,0,0},
																  {0,0,0},
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_ProductEq1_voiceEnhancer_lowMIPS[LVM_EQNB_MAX_BANDS_NBR] = {
 ...
 *
 */
LVM_InstParams_t InstParams_voiceEnhancer_lowMIPS = {
	/* General */
...
LVM_HeadroomBandDef_t HeadroomBandDef_voiceEnhancer_lowMIPS[LVM_HEADROOM_MAX_NBANDS]  = { {20,4999,3},    		/* Limit_Low, Limit_High, Headroom_Offset */
																		          {5000,24000,5},
																		          {0,0,0},
																		          {0,0,0},
																		          {0,0,0} };

LVM_HeadroomParams_t HeadroomParams_voiceEnhancer_lowMIPS = {
		.Headroom_OperatingMode	= LVM_HEADROOM_ON,  					/* Headroom Control On/Off */
		.pHeadroomDefinition	= &HeadroomBandDef_voiceEnhancer_lowMIPS[0],	/* Headroom band definition */
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_voiceEnhancer_lowMIPS = {
	/* General parameters */
	...
	.EQNB_NBands					= (LVM_UINT16)2,          		 // Number of bands 0 to LVM_EQNB_MAX_BANDS_NBR
	.pEQNB_BandDefinition			= &EQNB_BandDefs_UserEq1_voiceEnhancer_lowMIPS[0],// EQ band configuration
#endif /* ALGORITHM_EQNB */
	...
	.pPR_EQNB_BandDefinition		= &EQNB_BandDefs_ProductEq1_voiceEnhancer_lowMIPS[0],// EQ band configuration
...
#endif // end    EAP_PARAMETER_VOICE_ENHANCER

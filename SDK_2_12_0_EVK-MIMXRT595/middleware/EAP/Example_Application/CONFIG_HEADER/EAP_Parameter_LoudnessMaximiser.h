...
#ifndef EAP_PARAMETER_LOUDNESS_MAXIMISER
#define EAP_PARAMETER_LOUDNESS_MAXIMISER
/*******************************************************************/
/* Include */
/*******************************************************************/
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_loudnessMaximiser[LVM_EQNB_MAX_BANDS_NBR] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_ProductEq1_loudnessMaximiser[LVM_EQNB_MAX_BANDS_NBR] = {
 ...
 *
 */
LVM_InstParams_t InstParams_loudnessMaximiser = {
	/* General */
...
LVM_HeadroomBandDef_t HeadroomBandDef_loudnessMaximiser[LVM_HEADROOM_MAX_NBANDS]  = { {20,4999,3},    		/* Limit_Low, Limit_High, Headroom_Offset */
																		              {5000,24000,5},
																					  {0,0,0},
																					  {0,0,0},
																					  {0,0,0} };

LVM_HeadroomParams_t HeadroomParams_loudnessMaximiser = {
		.Headroom_OperatingMode	= LVM_HEADROOM_OFF,  						/* Headroom Control On/Off */
		.pHeadroomDefinition	= &HeadroomBandDef_loudnessMaximiser[0],	/* Headroom band definition */
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_loudnessMaximiser = {
	/* General parameters */
	...
	.pEQNB_BandDefinition			= &EQNB_BandDefs_UserEq1_loudnessMaximiser[0],// EQ band configuration
#endif /* ALGORITHM_EQNB */
	...
	.pPR_EQNB_BandDefinition		= &EQNB_BandDefs_ProductEq1_loudnessMaximiser[0],// EQ band configuration
...
#endif // end    EAP_PARAMETER_LOUDNESS_MAXIMISER

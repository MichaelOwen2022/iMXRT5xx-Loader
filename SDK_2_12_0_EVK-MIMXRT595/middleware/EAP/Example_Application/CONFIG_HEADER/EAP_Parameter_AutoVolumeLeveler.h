...
#ifndef EAP_PARAMETER_AUTO_VOLUME_LEVELER
#define EAP_PARAMETER_AUTO_VOLUME_LEVELER
/*******************************************************************/
/* Include */
/*******************************************************************/
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_autoVolumeLeveler[LVM_EQNB_MAX_BANDS_NBR] 	= {
																  {0,50,96},   	// gain(dB), freq(Hz) , Qfactor *100
																  {0,205,96},
																  {0,837,96},
																  {0,3427,96},
																  {0,0,0},
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_ProductEq1_autoVolumeLeveler[LVM_EQNB_MAX_BANDS_NBR] = {
																	  {0,50,96},   	// gain(dB), freq(Hz) , Qfactor *100
																	  {0,205,96},
																	  {0,837,96},
																	  {0,3427,96},
 ...
 *
 */
LVM_InstParams_t InstParams_autoVolumeLeveler = {
	/* General */
	.BufferMode		= LVM_MANAGED_BUFFERS,					/* Buffer management mode */
	.MaxBlockSize 	= 480,      	    					/* Maximum processing block size  */
...
LVM_HeadroomBandDef_t HeadroomBandDef_autoVolumeLeveler[LVM_HEADROOM_MAX_NBANDS]  = { {20,4999,3},    		/* Limit_Low, Limit_High, Headroom_Offset */
																					  {5000,24000,5},
																					  {0,0,0},
																					  {0,0,0},
																					  {0,0,0} };

LVM_HeadroomParams_t HeadroomParams_autoVolumeLeveler = {
		.Headroom_OperatingMode	= LVM_HEADROOM_OFF,  								/* Headroom Control On/Off */
		.pHeadroomDefinition	= &HeadroomBandDef_autoVolumeLeveler[0],			/* Headroom band definition */
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_autoVolumeLeveler = {
	/* General parameters */
	...
	.EQNB_NBands					= (LVM_UINT16)4,          		 // Number of bands 0 to LVM_EQNB_MAX_BANDS_NBR
	.pEQNB_BandDefinition			= &EQNB_BandDefs_UserEq1_autoVolumeLeveler[0],// EQ band configuration
#endif /* ALGORITHM_EQNB */
	...
	.pPR_EQNB_BandDefinition		= &EQNB_BandDefs_ProductEq1_autoVolumeLeveler[0],// EQ band configuration
#endif /* ALGORITHM_PR_EQNB */

#ifdef ALGORITHM_BASS
    /* Bass Enhancement parameters */
	.BE_OperatingMode 		= LVM_BE_OFF, 				// LVM_BE_ON or LVM_BE_OFF;
	.BE_EffectLevel 		= (LVM_INT16)LVM_BE_0DB, 	// LVM_BE_0DB or LVM_BE_3DB or LVM_BE_6DB or LVM_BE_9DB or LVM_BE_12DB or LVM_BE_15DB;
...
#endif // end    EAP_PARAMETER_AUTO_VOLUME_LEVELER

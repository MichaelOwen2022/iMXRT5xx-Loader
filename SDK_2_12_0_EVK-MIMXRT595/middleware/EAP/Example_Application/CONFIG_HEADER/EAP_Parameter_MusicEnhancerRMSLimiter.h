...
#ifndef EAP_PARAMETER_MUSIC_ENHANCER
#define EAP_PARAMETER_MUSIC_ENHANCER
/*******************************************************************/
/* Include */
/*******************************************************************/
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_musicEnhancerRmsLimiter[LVM_EQNB_MAX_BANDS_NBR] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_ProductEq1_musicEnhancerRmsLimiter[LVM_EQNB_MAX_BANDS_NBR] = {
 ...
 *
 */
LVM_InstParams_t InstParams_musicEnhancerRmsLimiter = {
	/* General */
...
LVM_HeadroomBandDef_t HeadroomBandDef_musicEnhancerRmsLimiter[LVM_HEADROOM_MAX_NBANDS]  = { {20,4999,3},    		/* Limit_Low, Limit_High, Headroom_Offset */
																						    {5000,24000,5},
																						    {0,0,0},
																						    {0,0,0},
																						    {0,0,0} };

LVM_HeadroomParams_t HeadroomParams_musicEnhancerRmsLimiter = {
		.Headroom_OperatingMode	= LVM_HEADROOM_ON,  							/* Headroom Control On/Off */
		.pHeadroomDefinition	= &HeadroomBandDef_musicEnhancerRmsLimiter[0],	/* Headroom band definition */
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_musicEnhancerRmsLimiter = {
	/* General parameters */
	...
	.pEQNB_BandDefinition			= &EQNB_BandDefs_UserEq1_musicEnhancerRmsLimiter[0],// EQ band configuration
#endif /* ALGORITHM_EQNB */
	...
	.pPR_EQNB_BandDefinition		= &EQNB_BandDefs_ProductEq1_musicEnhancerRmsLimiter[0],// EQ band configuration

...
#ifndef EAP_PARAMETER_ALL_EFFECT_OFF
#define EAP_PARAMETER_ALL_EFFECT_OFF
/*******************************************************************/
/* Include */
/*******************************************************************/
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_allEffectOff[LVM_EQNB_MAX_BANDS_NBR] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_ProductEq1_allEffectOff[LVM_EQNB_MAX_BANDS_NBR] = {
 ...
 *
 */
LVM_InstParams_t InstParams_allEffectOff = {
	/* General */
...
LVM_HeadroomBandDef_t HeadroomBandDef_allEffectOff[LVM_HEADROOM_MAX_NBANDS]  = { {20,4999,3},    		/* Limit_Low, Limit_High, Headroom_Offset */
																		         {5000,24000,5},
																		         {0,0,0},
																		         {0,0,0},
																		         {0,0,0} };

LVM_HeadroomParams_t HeadroomParams_allEffectOff = {
		.Headroom_OperatingMode	= LVM_HEADROOM_OFF,  		        /* Headroom Control On/Off */
		.pHeadroomDefinition	= &HeadroomBandDef_allEffectOff[0], /* Headroom band definition */
...
LVM_ControlParams_t	ControlParamSet_allEffectOff = {
	...
	.pEQNB_BandDefinition = &EQNB_BandDefs_UserEq1_allEffectOff[0],// EQ band configuration
#endif /* ALGORITHM_EQNB */
	...
	.pPR_EQNB_BandDefinition = &EQNB_BandDefs_ProductEq1_allEffectOff[0],// EQ band configuration
...
#endif // end    EAP_PARAMETER_ALL_EFFECT_OFF

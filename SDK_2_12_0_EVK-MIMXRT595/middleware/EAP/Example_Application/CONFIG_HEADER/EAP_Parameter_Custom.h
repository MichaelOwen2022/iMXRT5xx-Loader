...
#ifndef EAP_PARAMETER_CUSTOM
#define EAP_PARAMETER_CUSTOM
/*******************************************************************/
/* Include */
/*******************************************************************/
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_custom[LVM_EQNB_MAX_BANDS_NBR] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_ProductEq1_custom[LVM_EQNB_MAX_BANDS_NBR] = {
 ...
 *
 */
LVM_InstParams_t InstParams_custom = {
	/* General */
...
LVM_HeadroomBandDef_t HeadroomBandDef_custom[LVM_HEADROOM_MAX_NBANDS]  = { {20,4999,3},    		/* Limit_Low, Limit_High, Headroom_Offset */
																		   {5000,24000,5},
																		   {0,0,0},
																		   {0,0,0},
																		   {0,0,0} };

LVM_HeadroomParams_t HeadroomParams_custom = {
		.Headroom_OperatingMode	= LVM_HEADROOM_ON,  			/* Headroom Control On/Off */
		.pHeadroomDefinition	= &HeadroomBandDef_custom[0],	/* Headroom band definition */
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_custom = {
	/* General parameters */
	...
	.pEQNB_BandDefinition			= &EQNB_BandDefs_UserEq1_custom[0],// EQ band configuration
#endif /* ALGORITHM_EQNB */
	...
	.pPR_EQNB_BandDefinition		= &EQNB_BandDefs_ProductEq1_custom[0],// EQ band configuration
...
#endif // end    EAP_PARAMETER_CUSTOM

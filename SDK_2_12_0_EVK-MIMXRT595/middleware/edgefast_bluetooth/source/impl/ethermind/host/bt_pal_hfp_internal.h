...
#define BT_HFP_HF_SUPPORTED_FEATURES    (BT_HFP_HF_FEATURE_CLI | \
					 BT_HFP_HF_FEATURE_VOLUME | BT_HFP_HF_FEATURE_ESCO_S4)

/* HFP AG Supported features */
#define BT_HFP_AG_SUPPORTED_FEATURES    (BT_HFP_AG_FEATURE_REJECT_CALL |BT_HFP_AG_FEATURE_3WAY_CALL| BT_HFP_AG_FEATURE_CODEC_NEG| \
					 BT_HFP_AG_FEATURE_HF_IND | BT_HFP_AG_FEARTURE_ESCO_S4)

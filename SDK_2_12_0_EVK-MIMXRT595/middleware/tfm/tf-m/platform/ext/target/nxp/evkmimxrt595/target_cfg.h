...
/* Predefined NOR flash config options (Macronix Octal SPI Flash MX25UM51345G flash, connected to FlexSPI PORT A) */
#define NOR_FLASH_INSTANCE      1U  /* This the instance number of FLEXSPI, only support 1 */
#define NOR_FLASH_OPTION0       0xC0403000U   /* UM Table 84, 0xC0403006 */
#define NOR_FLASH_OPTION1       0U
#define FLASH_NEED_RESET        0
#define CACHE_BASE              CACHE64_CTRL0


#define SEC_VIO_IRQn            SECURE_VIOLATION_IRQn /* Security Violation Interrupt number synonim */

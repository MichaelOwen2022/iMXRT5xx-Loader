...
os.system('arm-none-eabi-objcopy -O ihex tfm_bl2_mcuboot/armgcc/release/tfm_bl2_mcuboot.elf tfm_bl2_mcuboot/armgcc/release/tfm_bl2_mcuboot.hex')                                   
...
os.system('echo loadfile tfm_bl2_mcuboot/armgcc/release/tfm_bl2_mcuboot.hex >> ' + FILE)        # flash the bootloader file into target
os.system('echo loadfile tfm_bl2_demo_s/armgcc/release/tfm_s_signed.bin 0x8000  >> ' + FILE)    # flash the signed secure image into target
os.system('echo loadfile tfm_bl2_demo_ns/armgcc/release/tfm_ns_signed.bin 0x30000  >> ' + FILE) # flash the signed non-secure image into target
os.system('echo r >> ' + FILE)                                                                # reset the target

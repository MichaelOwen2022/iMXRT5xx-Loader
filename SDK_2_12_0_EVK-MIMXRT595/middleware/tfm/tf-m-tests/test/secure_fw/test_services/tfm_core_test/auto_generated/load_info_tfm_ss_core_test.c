...
#define TFM_SP_CORE_TEST_NSERVS                                 (7)
#if TFM_LVL == 3
#define TFM_SP_CORE_TEST_NASSETS                                (0 + 1)
#else
#define TFM_SP_CORE_TEST_NASSETS                                (0)
#endif
...
const struct partition_tfm_sp_core_test_load_info_t tfm_sp_core_test_load
    ...
    .assets                         = {
        {
            .mem.start              = PART_REGION_ADDR(PT_TFM_SP_CORE_TEST_PRIVATE, _DATA_START$$Base),
            .mem.limit              = PART_REGION_ADDR(PT_TFM_SP_CORE_TEST_PRIVATE, _DATA_END$$Base),

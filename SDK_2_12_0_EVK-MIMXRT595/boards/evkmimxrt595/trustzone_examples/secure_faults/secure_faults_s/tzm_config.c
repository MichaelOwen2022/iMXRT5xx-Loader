...
#define XIP_SAU_REGION_0_END  0x20401FFFU
...
#define RAM_SAU_REGION_2_END  0x20401FFFU
...
- ahb:
  ...
  - regions: [{memory: BootROM, security: ns_user, start: '0x00000000', size: '0x00020000'}, {memory: FlexSPI0, security: s_priv, start: '0x00000000', size: '0x00100000'},
    ...
    {memory: SRAM_SHARED, security: ns_user, start: '0x00000000', size: '0x00060000'}, {memory: SRAM, security: ns_user, start: '0x00000000', size: '0x000B0000'},
    {memory: SRAM, security: s_priv, start: '0x000B0000', size: '0x00050000'}, {memory: SRAM, security: ns_user, start: '0x00100000', size: '0x00080000'}, {memory: SRAM,
      security: s_priv, start: '0x00180000', size: '0x00002000'}, {memory: SRAM, security: ns_user, start: '0x00182000', size: '0x000FE000'}, {memory: SRAM_DSP, security: ns_user,
      start: '0x00000000', size: '0x00200000'}, {memory: SmartDMA, security: ns_user, start: '0x00000000', size: '0x00008000'}, {memory: FlexSPI1, security: ns_user,
      start: '0x00000000', size: '0x08000000'}, {memory: USB_RAM, security: ns_user, start: '0x00000000', size: '0x00004000'}]
  ...
  - peripherals: {ns_user: {id: [ACMP0, ADC0, CACHE64_CTRL0, CACHE64_CTRL1, CASPER, CRC_ENGINE, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DEBUGGER_MAILBOX, DMA0,
        ...
        OSTIMER1, PINT, PMC, POWERQUAD, PUF, RTC, SCT0, SECGPIO, SEMA42, SMARTDMA, TRNG, USBHSD, USBHSH, USBPHY, USDHC0, USDHC1, UTICK0, WWDT0, WWDT1]}, s_priv: {
      id: [AHB_SECURE_CTRL, CLKCTL0, CLKCTL1, FLEXCOMM0, FLEXSPI0, IOPCTL, RSTCTL0, RSTCTL1, SYSCTL0, SYSCTL1]}}
- sau:
  - enabled: 'true'
  - all_non_secure: 'false'
  - generate_code_for_disabled_regions: 'false'
  - regions: [{index: '0', enabled: 'true', security: ns, start: '0x20380000', size: '0x00082000'}, {index: '1', enabled: 'true', security: ns, start: '0x40000000',
...
void XIP_BOARD_InitTrustZone()
{
    ...
    */
    ...
    AHB_SECURE_CTRL->RAM24_RULE[3]                                    = 0x33333333U;
    ...
    AHB_SECURE_CTRL->RAM28_RULE[0]                                    = 0x00000003U;
    ...
    AHB_SECURE_CTRL->APB_BRIDGE_PER0_RULE0        = 0xFCFFFFFFU;
    AHB_SECURE_CTRL->APB_BRIDGE_PER0_RULE1        = 0xCCFFFFFFU;
    AHB_SECURE_CTRL->APB_BRIDGE_PER1_RULE0        = 0xCCCFFFFFU;
...
- ahb:
  ...
  - regions: [{memory: BootROM, security: ns_user, start: '0x00000000', size: '0x00020000'}, {memory: FlexSPI0, security: s_priv, start: '0x00000000', size: '0x00040000'},
    ...
    {memory: SRAM, security: ns_user, start: '0x00040000', size: '0x00070000'}, {memory: SRAM, security: s_priv, start: '0x000B0000', size: '0x00050000'}, {memory: SRAM,
      security: ns_user, start: '0x00100000', size: '0x00080000'}, {memory: SRAM, security: s_priv, start: '0x00180000', size: '0x00002000'}, {memory: SRAM, security: ns_user,
      start: '0x00182000', size: '0x000FE000'}, {memory: SRAM_DSP, security: ns_user, start: '0x00000000', size: '0x00200000'}, {memory: SmartDMA, security: ns_user,
      start: '0x00000000', size: '0x00008000'}, {memory: FlexSPI1, security: ns_user, start: '0x00000000', size: '0x08000000'}, {memory: USB_RAM, security: ns_user,
      start: '0x00000000', size: '0x00004000'}]
  - masters: {ns_user: {id: [DMA0, DMA1, DSP, GPU, POWERQUAD, SDIO0, SDIO1, SDMA_D, SDMA_I]}}
  - peripherals: {ns_user: {id: [ACMP0, ADC0, CACHE64_CTRL0, CACHE64_CTRL1, CASPER, CLKCTL0, CLKCTL1, CRC_ENGINE, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DEBUGGER_MAILBOX,
        DMA0, DMA1, DMIC0, FLEXCOMM0, FLEXCOMM1, FLEXCOMM10, FLEXCOMM11, FLEXCOMM12, FLEXCOMM13, FLEXCOMM14, FLEXCOMM15, FLEXCOMM16, FLEXCOMM2, FLEXCOMM3, FLEXCOMM4,
        FLEXCOMM5, FLEXCOMM6, FLEXCOMM7, FLEXCOMM8, FLEXCOMM9, FLEXIO0, FLEXSPI0, FLEXSPI1, FREQME, GPIO, GPU, HASHCRYPT, I3C0, I3C1, INPUTMUX, LCDIF, MIPI_DSI_HOST,
        MRT0, MUA, MUB, OCOTP0, OSTIMER0, OSTIMER1, PINT, PMC, POWERQUAD, PUF, RSTCTL0, RSTCTL1, RTC, SCT0, SECGPIO, SEMA42, SMARTDMA, TRNG, USBHSD, USBHSH, USBPHY,
        USDHC0, USDHC1, UTICK0, WWDT0, WWDT1]}, s_priv: {id: [AHB_SECURE_CTRL, IOPCTL, SYSCTL0, SYSCTL1]}}
- sau:
  - enabled: 'true'
  - all_non_secure: 'false'
  - generate_code_for_disabled_regions: 'false'
  - regions: [{index: '0', enabled: 'true', security: ns, start: '0x002C0000', size: '0x00080000'}, {index: '1', enabled: 'true', security: nsc, start: '0x102BFE00',
      size: '0x00000200'}, {index: '2', enabled: 'true', security: ns, start: '0x20380000', size: '0x00082000'}, {index: '3', enabled: 'true', security: ns, start: '0x08041000',
...
void RAM_BOARD_InitTrustZone()
{
    ...
    */
    ...
    /* Security level configuration of PPC checker */
    AHB_SECURE_CTRL->APB_BRIDGE_PER0_RULE0        = 0xFCFFFFCCU;
    AHB_SECURE_CTRL->APB_BRIDGE_PER0_RULE1        = 0xCCFFFFFFU;
    AHB_SECURE_CTRL->APB_BRIDGE_PER1_RULE0        = 0xCCCFFFCCU;
    AHB_SECURE_CTRL->APB_BRIDGE_PER1_RULE1        = 0xCCCCCCCCU;
    AHB_SECURE_CTRL->APB_BRIDGE_PER1_RULE2        = 0xCCFCCCCCU;

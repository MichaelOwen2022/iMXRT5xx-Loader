...
/*! @name SEC_PIO0_25 (coord C12), USER_KEY1
  @{ */
/* Routed pin properties */
#define BOARD_INITPINS_SW1_PERIPHERAL SECGPIO   /*!<@brief Peripheral name */
#define BOARD_INITPINS_SW1_SIGNAL SECPIO0       /*!<@brief Signal name */
#define BOARD_INITPINS_SW1_CHANNEL 25           /*!<@brief Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_SW1_GPIO SECGPIO         /*!<@brief GPIO peripheral base pointer */

...
- pin_list:
  ...
  - {pin_num: C12, peripheral: SECGPIO, signal: 'SECPIO0, 25', pin_signal: PIO0_25/FC3_RTS_SCL_SSEL1/FREQME_GPIO_CLK/CTIMER_INP6/FC2_SSEL3/TRACEDATA_3/CLKIN/SEC_PIO0_25,
    ibena: enabled}
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin25_config = (/* Pin is configured as SEC_PIO0_25 */
                                         IOPCTL_PIO_FUNC8 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT0 PIN25 (coords: C12) is configured as SEC_PIO0_25 */

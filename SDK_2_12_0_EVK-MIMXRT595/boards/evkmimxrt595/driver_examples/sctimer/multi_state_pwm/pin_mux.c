...
- pin_list:
  - {pin_num: F16, peripheral: SCT0, signal: 'OUT, 0', pin_signal: PIO0_5/FC0_SSEL2/SCT0_GPI0/SCT0_OUT0/CTIMER_INP1/SEC_PIO0_5/ADC0_0}
  - {pin_num: F17, peripheral: SCT0, signal: 'OUT, 1', pin_signal: PIO0_6/FC0_SSEL3/SCT0_GPI1/SCT0_OUT1/CTIMER0_MAT0/SEC_PIO0_6/ADC0_8}
  ...
  - {pin_num: K16, peripheral: SCT0, signal: 'IN, 1', pin_signal: PIO0_10/FC1_CTS_SDA_SSEL0/SCT0_GPI7/SCT0_OUT7/CTIMER1_MAT3/FC0_SSEL2/SEC_PIO0_10, ibena: enabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* SCT0_PIN_INP7 is selected for SCT0 input 1 */
    INPUTMUX_AttachSignal(INPUTMUX, 1U, kINPUTMUX_Sct0PinInp7ToSct0);
    ...
    const uint32_t port0_pin10_config = (/* Pin is configured as SCT0_GPI7 */
                                         IOPCTL_PIO_FUNC2 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT0 PIN10 (coords: K16) is configured as SCT0_GPI7 */
    ...
    const uint32_t port0_pin5_config = (/* Pin is configured as SCT0_OUT0 */
                                        IOPCTL_PIO_FUNC3 |
                                        /* Disable pull-up / pull-down function */
                                        IOPCTL_PIO_PUPD_DI |
                                        /* Enable pull-down function */
                                        ...
                                        /* Input function is not inverted */
                                        IOPCTL_PIO_INV_DI);
    /* PORT0 PIN5 (coords: F16) is configured as SCT0_OUT0 */
    IOPCTL_PinMuxSet(IOPCTL, 0U, 5U, port0_pin5_config);

    const uint32_t port0_pin6_config = (/* Pin is configured as SCT0_OUT1 */
                                        IOPCTL_PIO_FUNC3 |
                                        /* Disable pull-up / pull-down function */
                                        IOPCTL_PIO_PUPD_DI |
                                        /* Enable pull-down function */
                                        ...
                                        /* Input function is not inverted */
                                        IOPCTL_PIO_INV_DI);
    /* PORT0 PIN6 (coords: F17) is configured as SCT0_OUT1 */

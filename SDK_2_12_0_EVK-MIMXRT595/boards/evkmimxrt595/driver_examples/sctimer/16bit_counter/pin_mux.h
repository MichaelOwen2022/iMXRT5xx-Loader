...
/*! @name SCT0_OUT0 (coord B12), Q3[2]/PWM_RED_LED
  @{ */
/* Routed pin properties */
#define BOARD_INITPINS_LED_RED_PERIPHERAL SCT0           /*!<@brief Peripheral name */
#define BOARD_INITPINS_LED_RED_SIGNAL OUT                /*!<@brief Signal name */

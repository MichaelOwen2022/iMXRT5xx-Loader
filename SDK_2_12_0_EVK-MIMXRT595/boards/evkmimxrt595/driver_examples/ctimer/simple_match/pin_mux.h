...
/*! @name CTIMER2_MAT0 (coord B12), Q3[2]/PWM_RED_LED
  @{ */
/* Routed pin properties */
#define BOARD_INITPINS_LED_RED_PERIPHERAL CTIMER2        /*!<@brief Peripheral name */
#define BOARD_INITPINS_LED_RED_SIGNAL MATCH              /*!<@brief Signal name */
#define BOARD_INITPINS_LED_RED_CHANNEL 0                 /*!<@brief Signal channel */
                                                         /* @} */

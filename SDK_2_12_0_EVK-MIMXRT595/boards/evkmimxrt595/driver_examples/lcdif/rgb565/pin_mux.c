...
- pin_list:
  - {pin_num: D17, peripheral: GPIO, signal: 'PIO2, 15', pin_signal: PIO2_15/SCT0_OUT9/CLKIN/SMARTDMA_PIO15/CMP0_D, ibena: enabled}
...
void BOARD_InitMipiPanelPins(void)
{
    ...
    const uint32_t port2_pin15_config = (/* Pin is configured as PIO2_15 */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT2 PIN15 (coords: D17) is configured as PIO2_15 */

...
- pin_list:
  ...
  - {pin_num: M5, peripheral: CLKCTL, signal: CLKOUT, pin_signal: PIO1_10/MCLK/FREQME_GPIO_CLK/CTIMER_INP10/CLKOUT, pupdena: disabled, pupdsel: pullDown, ibena: disabled,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port1_pin10_config = (/* Pin is configured as CLKOUT */
                                         IOPCTL_PIO_FUNC7 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT1 PIN10 (coords: M5) is configured as CLKOUT */

...
// ---------------------------------------------------------------
// Model name: "model"
// Total data size: 158784 (bytes)
// Activations allocation efficiency: 1.0000
// Placeholders:
//
//   Name: "input"
//   Type: i8[S:0.007874016 O:0][-1.008,1.000]<1 x 32 x 32 x 3>
//   Size: 3072 (elements)
//   Size: 3072 (bytes)
//   Offset: 0 (bytes)
//
//   Name: "CifarNet_Predictions_Reshape_1"
//   Type: i8[S:0.003906250 O:-128][0.000,0.996]<1 x 10>
//   Size: 10 (elements)
//   Size: 10 (bytes)
//   Offset: 3072 (bytes)
//
...
// Memory sizes (bytes).
#define MODEL_CONSTANT_MEM_SIZE    90112

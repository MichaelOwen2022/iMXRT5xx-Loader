...
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_device_mtp/<rtos>/readme.pdf.
For lite version, the files path is:
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_device_mtp_lite/<rtos>/readme.pdf.
Note

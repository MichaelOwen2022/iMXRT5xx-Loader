...
descriptors.*/
    ...
    0x02,                                             /* Capability type: USB 2.0 EXTENSION (002H) */
    0x1e, /* bmAttributes,supports the Link Power Management protocol, BESL&Alternate HIRD definitions support. */
    0x63, /*baseline BESL & deep BESL value*/
    0x00, /*Reserved*/
    0x00  /*Reserved*/
};
#endif
...
/* Get bos descriptor request */
usb_status_t USB_DeviceGetBOSDescriptor(usb_device_handle handle,
                                        usb_device_get_bos_descriptor_struct_t *deviceDescriptor)
{
    deviceDescriptor->buffer = USB_BOSDescriptor;
    deviceDescriptor->length = USB_DESCRIPTOR_LENGTH_BOS_ALL;
    return kStatus_USB_Success;
}

...
#define DSP_AUDIO_BUFFER_2_PING (0x00830000)
#define DSP_AUDIO_BUFFER_2_PONG (0x00838000)
...
#define AUDIO_SHARED_BUFFER_1      0x20030000
#define AUDIO_SHARED_BUFFER_1_SIZE (128 * 1024)
#define AUDIO_SHARED_BUFFER_2      0x20050000
